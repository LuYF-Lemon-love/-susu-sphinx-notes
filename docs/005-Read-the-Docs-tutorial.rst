...
源教程地址: https://docs.readthedocs.io/en/stable/tutorial/ .
...
.. note::
   ...
   You can learn more about `our two different sites <https://docs.readthedocs.io/en/stable/choosing-a-site.html>`_ .
...
.. note::
   ...
   so we would like to kindly ask you to `not block us <https://docs.readthedocs.io/en/stable/advertising/ad-blocking.html>`_ |:heart:|
...
Read the Docs allows you to `trigger builds from GitHub pull requests <https://docs.readthedocs.io/en/stable/pull-requests.html>`_
...
using the ``.readthedocs.yaml`` `configuration file <https://docs.readthedocs.io/en/stable/config-file/v2.html>`_ .
...
``version``
  Mandatory, specifies `version 2 of the configuration file <https://docs.readthedocs.io/en/stable/config-file/v2.html>`_ .
...
Read the Docs allows you to have `several versions of your documentation <https://docs.readthedocs.io/en/stable/versions.html>`_ ,
...
The `How to use traffic analytics <https://docs.readthedocs.io/en/stable/analytics.html>`_ view shows the top viewed documentation pages of the past 30 days,
...
to inspect `what search terms your readers use <https://docs.readthedocs.io/en/stable/guides/search-analytics.html>`_
