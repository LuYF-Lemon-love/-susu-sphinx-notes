...
📚 `docs/ <https://github.com/LuYF-Lemon-love/susu-sphinx-notes/blob/main/docs/>`_
    A basic Sphinx project lives in ``docs/``. All the ``*.rst`` make up sections in the documentation.
⚙️ `.readthedocs.yaml <https://github.com/LuYF-Lemon-love/susu-sphinx-notes/blob/main/.readthedocs.yaml>`_
    Read the Docs Build configuration is stored in ``.readthedocs.yaml``.
⚙️ `docs/conf.py <https://github.com/LuYF-Lemon-love/susu-sphinx-notes/blob/main/docs/conf.py>`_
...
📍 `docs/requirements.txt <https://github.com/LuYF-Lemon-love/susu-sphinx-notes/blob/main/docs/requirements.txt>`_ and `docs/requirements.in <https://github.com/LuYF-Lemon-love/susu-sphinx-notes/blob/main/docs/requirements.in>`_
...
💡 `docs/api.rst <https://github.com/LuYF-Lemon-love/susu-sphinx-notes/blob/main/docs/api.rst>`_
...
💡 `docs/usage.rst <https://github.com/LuYF-Lemon-love/susu-sphinx-notes/blob/main/docs/usage.rst>`_
